...
export default function Form(){
    ...
    const addTodo = e => {
        ...
        const newArr = [...dataArr] //On a creé un nouveau tableau avec tous les objects à l intérieur car, on ne peut pas recopier un tableau ou un object existant donc on va toujours utilise le spread operator qui va récuperer tous les éléments de dataArr
