...
export default function Form(){
    ...
    const addTodoList = e => {
        ...
        const newArra = [...dataArray] //On a creé un nouveau tableau avec tous les objects à l intérieur car, on ne peut pas recopier un tableau ou un object existant donc on va toujours utiliser le spread operator qui va récuperer tous les éléments de dataArr
        ...
        newArr.push(newTodoList);//On push le nouvel object ds le tableau que l on a recopié
