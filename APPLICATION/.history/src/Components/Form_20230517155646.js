...
export default function Form(){
    ...
    const addTodo = e => {
        e.preventDefault();//Pour éviter que le formulaire se mette à jour à chaque fois que l on valide le formulaire,preventDefault()
        const newArr = [...dataArr] //On a creé un nouveau tableau avec tous les objects à l intérieur car, on ne peut pas recopier un tableau existant et on utilise le spread operator qui va récuperer tous les éléments de dataArr
