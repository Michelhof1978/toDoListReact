...
export default function Form(){
    ...
    const deleteElement = id => {//On passe cette fonction en props
        ...
        setDataArr(filteredState)// On actualise l ancien state et on remets à jour avec un nouveau state, cela, lors du clic sur boutton pour supprimer, l item va disparaître
    }
