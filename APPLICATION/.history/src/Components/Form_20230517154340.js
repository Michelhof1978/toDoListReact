...
export default function Form(){
    ...
    const addTodo = e => {
        e.preventDefault();
        const newArr = [...dataArr] //On a creé un nouveau tableau avec tous les objects à l intérieur car, on ne peut paset on utilise le sprread operator qui va récuper tous les éléments de dataArr
