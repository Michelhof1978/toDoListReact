...
<form onSubmit={e => addTodoList(e)} className="mb-3">
                ...
                e.target est une référence à l'objet qui a envoyé l'événement. orsque le gestionnaire d'événements est appelé au cours de la phase de propagation ou de la phase de capture de l'événement.
                type="text" 
